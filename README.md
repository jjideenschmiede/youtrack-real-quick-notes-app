...
A YouTrack dashboard widget for jotting down quick notes directly inline with automatic saving — no detour through the widget settings required.
...
The App adds a dashboard widget to YouTrack that lets you write notes directly inside the widget itself. Every change is saved automatically, so you never have to open the widget settings just to jot something down.

## Requirements

- YouTrack 2024.3 or later

## Installation

1. Download the latest release from the [marketplace](https://plugins.jetbrains.com/)
